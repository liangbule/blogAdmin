...
import {addArticle, editeArt, getArtId, mdArt} from '../../api'
        ...
        <>
            ...
            <div className="p20">
                ...
                <div className='btnbox'>
                    ...
                    <Button type="primary" style={{width: '100px', marginLeft: '20px'}}
                            onClick={openViewArticle}>预览</Button>
